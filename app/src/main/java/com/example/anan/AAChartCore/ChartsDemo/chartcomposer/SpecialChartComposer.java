...
public class SpecialChartComposer {
    ...
    public static AAChartModel configurePieChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureBubbleChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureArearangeChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureAreasplinerangeChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureColumnrangeChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureBoxplotChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configurePyramidChart() {
        return new AAChartModel()
    ...
    public static AAChartModel configureErrorbarChart() {
        return new AAChartModel()
                .categories(new String[]{
                        "一月", "二月", "三月", "四月", "五月", "六月",
                        "七月", "八月", "九月", "十月", "十一月", "十二月"
